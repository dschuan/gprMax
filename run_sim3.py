...
for x in range(20):
    ...
    output = "3concrete_voids"
    output_merge = "3concrete_voids_merged.out"

    p1 = subprocess.Popen("python -m gprMax 3concrete_voids.in -n 120 -gpu", shell=True)
    ...
    with open("./iden.json", "w") as jsonFile:
        data["identifier2"] = int(time.time())
        json.dump(data, jsonFile, indent=4)

    print("Image exported 3")
